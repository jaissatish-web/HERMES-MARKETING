...
export default function Home() {
  ...
  if (!session) return (
    <main className="authPage"><div className="authGlow glowOne" /><div className="authGlow glowTwo" />
